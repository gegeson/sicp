...
という意味かな？
->翌日気付いたが、'if とか 'set! とかを型として扱って良い、という意味だった。つまり 'eval は要らない。
  小さいことなので修正版を改めて作らなくていいかな。
  あとここを見たら、'call を使わずに apply を扱う方法があることを知った。
  http://www.serendip.ws/archives/1830
