...
;追記:もうひとつ理解を妨げてたことを見つけた。
;make-code-treeが木と木を受け取り木を返すということも可能になっている、ということをよく理解してなかった。
;これらが可能だとわかっていたら多分作れた気がする…
;基礎事項の理解を疎かにして問題を解こうとしてはいけない、という教訓。
...
(newline)
;次に、ネットのを参考にして自分の書きかけを完成させたバージョン
