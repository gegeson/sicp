...
(define z1 (make-complex-from-real-imag 0 2.0))
(define z2 (make-complex-from-real-imag 0 2.0))
(define z3 (make-complex-from-real-imag 2 1))
(display (equ? z1 z2))
(newline)
(display (equ? z1 z3))
(newline)
...
(define q2 (make-rational 12 9))
(define q3 (make-rational 11 7))
(display (equ? q1 q2))
(newline)
(display (equ? q1 q3))
(newline)
